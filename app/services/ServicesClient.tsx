...
export default function ServicesClient() {
  const services = [
    ...
    },
    {
      ...
      description:
        "北海道全域で1号・2号・4号警備を展開。機械警備を核に、企業・施設・イベントのリスクを最小化し、個人・法人の身辺警護にも対応。確かな運用で高品質なセキュリティを提供します。",
      image: "/Lsecurity.jpg",
    ...
    },
    {
      ...
      name: "北海工務店（建設・不動産事業）",
      description:
        "住宅・店舗・オフィスの建築やリフォーム、清掃、メンテナンスまでトータルに対応。地域密着の確かな施工力で、安心・安全な住まいづくりを提供します。",
